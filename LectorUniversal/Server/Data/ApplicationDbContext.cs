...
namespace LectorUniversal.Server.Data
{
    public class ApplicationDbContext : ApiAuthorizationDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            //{
            //    Id = "7f10bef8-3d68-4a7d-8262-7846e339e7d2",
            //    UserName = "AcarioG",
            //    NormalizedUserName = "ACARIOG",
            //    Email = "wilmervasquez219@gmail.com",
            //    NormalizedEmail = "WILMERVASQUEZ219@GMAIL.COM",
            //    EmailConfirmed = true,
            //    PasswordHash = "AQAAAAEAACcQAAAAENyGMozmIMj3qkPBGtXK6uq+LtRPpYIKrwHenak+3N1YwR0QhffQS1TrcA05HRz8bg==",
            //    SecurityStamp = "XAAIWXV5PF3EPASY7ONECLRUAPKWSUBY",
            //    ConcurrencyStamp = "bfb6ef6e-e803-4a81-bc55-edbdbe25be53",
            //    PhoneNumber = "8297500421",
        ...
        public DbSet<ChapterFinished> ChapterFinisheds { get; set; }
    }
}